        ...
        <div className="w-screen-xl flex items-center justify-between  p-2">
          ...
          <div className="flex-1 max-w-lg ml-4">
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full p-2 pl-10 text-sm text-gray-900  border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search..."
              />
            </div>
          </div>
